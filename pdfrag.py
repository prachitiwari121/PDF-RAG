...
# # Function to split the extracted text into chunks for vector storage
# def get_text_chunks(text):
#     text_splitter = RecursiveCharacterTextSplitter(chunk_size=5000, chunk_overlap=500)
#     chunks = text_splitter.split_text(text)
#     return chunks

# # Function to create a FAISS vector store from text chunks and save it locally
# def get_vector_store(text_chunks):
#     embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001")
#     # Debugging the embeddings and text chunks
#     if not text_chunks:
...
# # Function to set up the conversational chain with Google Gemini AI
...
# # Function to handle user input and search for relevant information in the FAISS vector store
